...
class AlertService:
    ...
    def get_config(self) -> dict:
        ...
        return {
            "temperature": {"min": self._config["temp_min"], "max": self._config["temp_max"]},
            "consumption": {"max": self._config["consumption_max"]},
        }

    def update_config(
        self, temp_min: float = None, temp_max: float = None, consumption_max: float = None
    ) -> dict:
