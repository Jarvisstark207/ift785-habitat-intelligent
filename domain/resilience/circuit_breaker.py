...
# ------------------------------------------------------------------
# Registry global — un Circuit Breaker par service externe (Bulkhead)
# ------------------------------------------------------------------
...
def get_circuit_breaker(
    ...
    """Retourne (ou cree) le Circuit Breaker associe au service *name*."""
    with _registry_lock:
...
def get_all_circuit_breakers() -> Dict[str, CircuitBreaker]:
    """Retourne une copie du registre global."""
    with _registry_lock:
        return dict(_registry)


def reset_all_circuit_breakers() -> None:
    """Remet tous les circuits a l'etat initial (utile pour les tests)."""
    with _registry_lock:
