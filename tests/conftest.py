...
def populated_db(temp_db):
    ...
    for location in locations:
        ...
        for i in range(20):
            ...
            """,
                (f"temp_{location}_{i}", location, "temperature", 20.0 + i * 0.2, "°C", timestamp),
            )
            ...
            """,
                (f"light_{location}_{i}", location, "lumiere", 500 + i * 10, "lux", timestamp),
            )
            ...
            """,
                (f"power_{location}_{i}", location, "consommation", 100 + i * 5, "W", timestamp),
            )
