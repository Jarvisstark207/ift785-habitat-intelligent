...
class TestAdapterIntegration:
    ...
    def test_tous_adapters_retournent_status_valide(self):
        """Tous les adapters retournent un statut au format standard"""
    ...
    def test_tous_adapters_retournent_devices_valides(self):
        """Tous les adapters retournent des appareils au format standard"""
        adapters = [PhilipsHueAdapter(), NestAdapter(), GenericAdapter()]
        required_keys = {"id", "name", "type", "status"}
        for adapter in adapters:
            for device in adapter.get_devices():
